      ...
      <div className="circular-footer-inner px-4 px-md-5">
        <div className="row g-4 align-items-center">
          <div className="col-lg-7">
            ...
            <p className="mb-0 fw-semibold circular-text-soft">Círculos con calidez y confianza.</p>
          </div>

          <div className="col-lg-5">
            <div className="donation-card rounded-5 p-4">
              <p className="text-uppercase small fw-semibold circular-eyebrow mb-2">PayPal</p>
